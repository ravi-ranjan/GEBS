...
Author: Vinod Kumar
Version: 0.8.2
Author URI: http://solution4technical.com/
...
function cpt_plugin_menu() {
	...
	add_menu_page( __( 'Custom Post Types', 'cpt-plugin' ), __( 'Custome Post Type', 'cpt-plugin' ), 'manage_options', 'cpt_main_menu', 'cpt_manage_cpt' );
